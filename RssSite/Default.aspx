...
<%@ Register Src="~/Controls/DefaultMenuControl.ascx" TagName="MenuControl" TagPrefix="Jiyuu" %>
<asp:Content runat="server" ContentPlaceHolderID="MenuPlaceHolder" ID="contentMenu">
<Jiyuu:MenuControl runat="server" ID="DefaultMenuControl" />
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder" ID="content1">
    <div id="contentHolder" class="span-24 last">
        <div class="span-5 colborder">
            <h3 class="alt">חיפוש תגים</h3>
            <div class="box" style="background-color: #FFE6CC;" id="TagSearchDiv">
                <input type="text" id="TagSearchInput" size="20" style="width: 65%;" onkeypress="return SwitchEnterAction(submitSearchTag)" /><input
                    type="button" value="חפש" style="width: 28%;" onclick="return submitSearchTag();" />
            </div>
            <h3 class="alt">בלוגים</h3>
            <asp:Repeater runat="server" ID="BlogsRepeater">
                <ItemTemplate>
                    <a href="?BlogID=<%#Eval("BlogID") %>"><span class="box" style="padding: 0.5em 0.5em 0.5em 0.5em;
                        margin-bottom: 1em; display: block;">
                        <%#Eval("BlogName") %></span></a>
                </ItemTemplate>
            </asp:Repeater>
            <h3 class="alt">עזרים</h3>
            ...
            <h3 class="alt">דברים שנותרו לעשות</h3>
            ...
            <ul>
                ...
                <li><span style="text-decoration: line-through;">להוסיף את כל הבלוגים הרלוונטים למערכת
                    </span>פחות או יותר</li>
                ...
                <li><span style="text-decoration: line-through;">טיפול בעריכת פוסטים</span>חוץ מפייסבוק
                </li>
                <li><span style="text-decoration: line-through;">אווטאר לכל בלוג</span>כמעט לכולם
                </li>
                <li><span style="text-decoration: line-through;">קישור לפוסט מהשלוש נקודות בסוף התקציר
                </span></li>
            ...
            <asp:Repeater runat="server" ID="PostsRepeater">
                <ItemTemplate>
                    <table style="width: 650px; margin-left: auto; margin-right: auto; border: solid 1px black;">
                        <tr>
                            <td rowspan="2" style="width: 52px; padding: 0px;">
                                <img alt="logo" src="/images/logos/<%#Eval("Blog.BlogId")%>.png" class="BlogLogo" />
                            </td>
                            <td style="text-align: center; font-weight: bold;"><span style="margin-right: -52px">
                                כותרת: <a class="loud" href="<%#Eval("Link") %>">
                                    <%#Eval("Title") %></a></span></td>
                        </tr>
                        <tr>
                            <td>
                                <div style="float: right; width: 50%;">ע"י:
                                    <%#Eval("PostAuthor.AuthorName")%><span style="font-size: x-small"> מהבלוג: <a href="<%#Eval("Blog.HomepageURL")%>">
                                        <%#Eval("Blog.BlogName")%></a></span></div>
                                <div style="float: right;">בתאריך:
                                    <%#Eval("PublicationTS")%></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">מתוייג כ:
                                <%#getCategories() %></td>
                        </tr>
                        <tr id="PostSummary_<%#Eval("PostID")%>">
                            <td colspan="2">
                                <%#getSummary()%>
                                [<a href="<%#Eval("Link") %>">...</a>]</td>
                        </tr>
